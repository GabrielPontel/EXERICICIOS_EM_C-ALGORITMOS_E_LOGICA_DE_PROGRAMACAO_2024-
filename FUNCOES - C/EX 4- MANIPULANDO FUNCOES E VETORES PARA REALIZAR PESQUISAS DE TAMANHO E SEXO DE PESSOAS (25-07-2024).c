#include <stdio.h>
/*
O IFSP realizou uma pesquisa entre os habitantes de Presidente Epitácio e coletados os dados de altura e sexo (M =
masculino, F = feminino) das pessoas. Faça um programa que leia dados de N pessoas, sendo que a pesquisa se es
tende a no máximo 100 pessoas e informe:
