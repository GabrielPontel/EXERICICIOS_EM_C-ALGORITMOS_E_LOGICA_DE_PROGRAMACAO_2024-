...
/*
Fazer um programa em linguagem C utilizando funções, sem utilizar a biblioteca string.h, e seja
capaz de:
...
c. Copiar uma parte de uma string para dentro de outra, para isso deve-se conhecer a posição
inicial e o final a ser copiada;
d. Copiar a última palavra de uma string para outra string;
e. Copiar a primeira palavra de uma string para outra;
f.
Retirar os espaços em branco repetidos de uma string;
