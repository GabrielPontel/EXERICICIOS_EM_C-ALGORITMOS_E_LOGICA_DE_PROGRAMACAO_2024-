...
/*
Fazer um programa em linguagem C utilizando funções capaz de simular uma lista de nomes e seja
possível:
a. Determinar a quantidade de pessoas que os nomes iniciam com uma determinada letra;
b. Determinar a posição na lista de um determinado nome;
c. Localizar a quantidade de ocorrência de uma determinada letra;
d. Apresentar todos os nomes iniciados com uma determinada string;
e. A posição da pessoa que possui o maior nome;
f.
