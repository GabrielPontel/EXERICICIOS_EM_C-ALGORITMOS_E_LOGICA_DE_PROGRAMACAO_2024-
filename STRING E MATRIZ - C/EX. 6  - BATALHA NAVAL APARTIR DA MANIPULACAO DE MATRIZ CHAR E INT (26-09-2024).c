...
/*
Fazer um programa em linguagem C utilizando funções, capaz de preencher uma matriz de 10 por
10 com zeros e posteriormente inserir em posições aleatórias 20 números aleatórios entre 2 e 20, e
seja capaz de simular um jogo de batalha naval, do usuário contra a máquina. Com os seguintes
critérios:
• o jogo deve possuir 20 rodadas;
• a cada rodada o usuário escolhe a posição (linha e coluna) onde vai atirar, se nessa posição
tiver um número zero, o usuário não atingiu nada e nenhum ponto é computado; Caso na
posição for encontrado um número diferente de zero, o número encontrado é a quantidade de
pontos obtida pelo usuário.
• O computador fará a jogada logo após o usuário, gerando de forma aleatória a posição onde vai
atirar, e seguindo a mesma mecânica do usuário.
• Ao final das 20 rodadas, quem obteve a maior quantidade de pontos será o vencedor.
*/
